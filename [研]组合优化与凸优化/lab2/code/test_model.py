...
def parser_option():
    ...
    parser.add_argument('--dataset', type=str, default='cifar100', choices=['emnist', 'polarity', 'cifar10', 'cifar100', 'imagenet', 'tiny_imagenet', 'stl10', 'imageclef', 'objectnet'], help='dataset')
...
def main():
    ...
    if opt.dataset == 'cifar100':
        ...
        _, _, val_loader, test_loader = get_objectnet_dataloaders(batch_size=opt.batch_size, num_workers=opt.num_workers)
        n_cls = 1000
