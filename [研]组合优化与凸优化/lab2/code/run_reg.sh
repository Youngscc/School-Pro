# exp No.0
# CUDA_VISIBLE_DEVICES=0,1 python test_model.py --dataset emnist --dataset_size 1.0 \
...
# exp No.1
# CUDA_VISIBLE_DEVICES=0,1 python test_model.py --dataset stl10 --dataset_size 1.0 \
...
# exp No.3
# CUDA_VISIBLE_DEVICES=9,10 python test_model.py --dataset cifar100 --dataset_size 1.0 \
...
# exp No.4
# CUDA_VISIBLE_DEVICES=9,10 python test_model.py --dataset imageclef --category 'p' --dataset_size 1.0 \
...
# exp No.5
# CUDA_VISIBLE_DEVICES=2,3 python test_model.py --dataset objectnet --dataset_size 1.0  \
...
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# for KD models
# CUDA_VISIBLE_DEVICES=0,1 python test_model.py --dataset cifar100 --dataset_size 1.0 \
   # --old_model densenet40 --oldmodel_path ./save/models/densenet40_cifar100_0.25_lr_0.05_decay_0.0_trial_1/densenet40_dataset_0.25_best.pth \
   # --new_model resnet110 --newmodel_path /data/share/
...
CUDA_VISIBLE_DEVICES=0,1 python test_model.py --dataset cifar100 --dataset_size 1.0 \
   ...
   --new_model cifarresnet50 --newmodel_path /data/share/
