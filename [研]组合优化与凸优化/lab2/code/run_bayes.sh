...
# exp No.1
# CUDA_VISIBLE_DEVICES=0,1 python regbug_bayesian.py --dataset stl10 --dataset_size 1.0 --combine 'CostRatio' \
...
# exp No.3
# CUDA_VISIBLE_DEVICES=9,10 python regbug_bayesian.py --dataset cifar100 --dataset_size 1.0 --combine 'CostRatio' \
   # --old_model densenet40 --oldmodel_path ./save/models/densenet40_cifar100_0.2_lr_0.05_decay_0.0_trial_1/densenet40_dataset_0.2_best.pth \
   # --new_model resnet110 --newmodel_path ./save/models/resnet110_cifar100_0.8_lr_0.05_decay_0.0005_trial_1/resnet110_dataset_0.8_best.pth

# exp No.4
# CUDA_VISIBLE_DEVICES=9,10 python regbug_bayesian.py --dataset imageclef --category 'p' --dataset_size 1.0 --combine 'CostRatio' \
...
# exp No.5
CUDA_VISIBLE_DEVICES=9,10 python regbug_bayesian.py --dataset objectnet --dataset_size 1.0 --combine 'CostRatio' \
